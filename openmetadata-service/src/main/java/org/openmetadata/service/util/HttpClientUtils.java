...
public final class HttpClientUtils {
  ...
  private static String body(
      HttpEntityEnclosingRequestBase httpMethod, Map<String, String> headers, Map<String, String> params) {
    try {
      if (params != null) {
  ...
  public static void stream(
      HttpRequestBase httpMethod, Map<String, String> headers, Function<InputStream, Void> function) {
    if (headers != null) {
      for (Map.Entry<String, String> header : headers.entrySet()) {
        // 设置到请求头到HttpRequestBase对象中
        httpMethod.setHeader(header.getKey(), header.getValue());
  ...
  public static String appendParams(String url, Map<String, String> params) {
    try {
      ...
      throw new RuntimeException("请求地址异常：" + url);
    }
  }
}
