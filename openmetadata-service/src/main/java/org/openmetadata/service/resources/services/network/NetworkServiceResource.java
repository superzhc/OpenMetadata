    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content =
                            @Content(mediaType = "application/json", schema = @Schema(implementation = org.openmetadata.service.resources.services.network.NetworkServiceResource.NetworkServiceList.class)))
            })
...
//    }
    ...
    public EntityHistory listVersions(
            @Context UriInfo uriInfo,
            @Context SecurityContext securityContext,
            @Parameter(description = "Id of the Network service", schema = @Schema(type = "UUID")) @PathParam("id")
            UUID id) {
